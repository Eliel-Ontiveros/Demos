/**
 * ╔══════════════════════════════════════════════════════════╗
 * ║    BREAKING POINT STRESS TEST — WEBFLUX (Spring/Java)    ║
 * ║  Objetivo: Encontrar el límite máximo del framework       ║
 * ║  Puerto  : 8082                                           ║
 * ║  Ejecución: k6 run stress-test-webflux.js                 ║
 * ╚══════════════════════════════════════════════════════════╝
 *
...
export function handleSummary(data) {
    return {
        ...
        "stress-webflux-results.json": JSON.stringify(data, null, 2),
    };
}
